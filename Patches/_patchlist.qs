...
registerPatch( 13, "DisableFilenameCheck", 'Disable Ragexe Filename Check', 'Fix', 0, "Shinryo", 'Disables the check that forces the client to quit if not called an official name like ragexe.exe in langtype 0', true);
...
//23 is Unused - to be filled

registerPatch( 24, "FixCameraAnglesRecomm", 'Fix Camera Angles', 'UI', 2, "Shinryo", 'Unlocks the possible camera angles to give more freedom of placement. Gives a medium range of around 60 degress', true);
...
registerPatch( 80, "SharedBodyPalettesV1", 'Shared Body Palettes Type1', 'UI', 6, "Ai4rei/AN, Neo", 'Makes the client use a single cloth palette set (body_%s_%d.pal) for all job classes but seperate for both genders', false);

//81 is Unused - to be filled

registerPatch( 82, "SharedHeadPalettesV1", 'Shared Head Palettes Type1', 'UI', 7, "Ai4rei/AN, Neo", 'Makes the client use a single hair palette set (head_%s_%d.pal) for all job classes but seperate for both genders', false);
...
//91 is Unused - to be filled

registerPatch( 92, "PacketFirstKeyEncryption", 'Packet First Key Encryption', 'Packet', 9, "Shakto, Neo", 'Change the 1st key for packet encryption. Dont select the patch Disable Packet Header Encryption if you are using this. Don\'t use it if you don\'t know what you are doing. (Not available yet on rathena)', false);

registerPatch( 93, "PacketSecondKeyEncryption", 'Packet Second Key Encryption', 'Packet', 9, "Shakto, Neo", 'Change the 2nd key for packet encryption. Dont select the patch Disable Packet Header Encryption if you are using this. Don\'t use it if you don\'t know what you are doing. (Not available yet on rathena)', false);

registerPatch( 94, "PacketThirdKeyEncryption", 'Packet Third Key Encryption', 'Packet', 9, "Shakto, Neo", 'Change the 3rd key for packet encryption. Dont select the patch Disable Packet Header Encryption if you are using this. Don\'t use it if you don\'t know what you are doing. (Not available yet on rathena)', false);
...
//101 is Unused - to be filled

//This patch is not needed since the issue is fixed Server Side - to be removed
